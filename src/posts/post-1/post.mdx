...
experience) can only take you so far- I'll rant more about this in a later post.

So yeah, I could've used a template, I could've forked some Github project and just changed a few lines
and called it a day. My site wouldn't look nearly as bad. But that wouldn't have been fun, and coding
should be fun! &#128521;
